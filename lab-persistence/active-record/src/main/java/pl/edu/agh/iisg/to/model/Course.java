...
public class Course {
    ...
    public List<Student> studentList() {
        String findStudentListSql = "SELECT * FROM student s INNER JOIN " +
                "student_course sc ON s.id = sc.student_id WHERE sc.course_id = ?";
...
//problem n+1 zapytań
        ...
        try {
            ...
            ResultSet rs = QueryExecutor.read(findStudentListSql, id());
